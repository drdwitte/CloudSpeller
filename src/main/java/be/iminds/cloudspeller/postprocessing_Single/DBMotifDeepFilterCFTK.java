 ...
 */
public class DBMotifDeepFilterCFTK extends Configured implements Tool {

    private static String input;
    private static String output;

    public static class DeepFilterMapperCFTK extends Mapper<LongWritable,Text,NullWritable,Text> {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(getConf(), "DBMotifDeepFilterCFTK");

        job.setJarByClass(DBMotifDeepFilterCFTK.class);
        ...
        job.setMapperClass(DeepFilterMapperCFTK.class);
    ...
    private static void processCommandLineArgs(String[] args, Job job) {
        ...
        if (other_args.size()!=2){
            ...
            System.out.println("Current parameter values: C="+confidenceCutoff+" F="+ familyCutoff+" BLS="+minBLS+" k="+k);
            printUsage();
        }
    ...
    private static int printUsage() {
        System.out.println("bin/hadoop jar DeepFilter.jar -C 90 -F 10 -BLS 15 -k 12  input/ output/");
        return -1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            res = ToolRunner
                    .run(new Configuration(), new DBMotifDeepFilterCFTK(), args);
        } catch (Exception ex) {
